...
function Podcast() {
    return (
        <div className='w-screen h-screen relative bg-[#001D1B]' id='podcast'>
            <div className='w-screen h-screen absolute top-0 right-0 flex justify-center items-center _p-4 md:p-10'>
                <div className='w-full md:w-2/3 h-full flex flex-col items-center justify-evenly text-center'>
                    <div className={`z-10 lg:py-20 text-3xl md:text-5xl text-[#CBC6C6] ${scriptFont.className}`}>Podcast</div>
